...
import { jobPostingsApi } from '../../../../api/core/index'
import type { CreateJobPostingCommand } from '../../../../api/jobs/job-postings'
import { DashboardSurface, InteractiveButton, StatePanel } from '../../../../shared/ui/ui-primitives'
